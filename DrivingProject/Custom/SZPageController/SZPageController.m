    ...
    if (recognizer.state == UIGestureRecognizerStateBegan) {
        ...
        if (self.contentModeController) {
            ...
            if (self.isLeft) {
                ...
                self.tempController.view.frame = CGRectMake(tempPoint.x - self.view.width, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                
            } else {
                self.currentController.view.frame = CGRectMake(tempPoint.x > 0 ? 0 : tempPoint.x, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
            ...
            if (self.isLeft) {
                ...
                self.tempView.frame = CGRectMake(tempPoint.x - self.view.width, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                
            } else {
                
                self.currentView.frame = CGRectMake(tempPoint.x > 0 ? 0 : tempPoint.x, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
            }
        }
    } else { //!< 手势结束
        if (!self.isPan) return;
                ...
                if (animated) {
                    ...
                    [UIView animateWithDuration:AnimateDuration animations:^{
                        ...
                        if (isSuccess) {
                            ...
                            weakSelf.tempController.view.frame = CGRectMake(0, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                            
                        }else{
                            
                            weakSelf.tempController.view.frame = CGRectMake(-self.view.width, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                        }
                    ...
                    if (isSuccess) {
                        ...
                        self.tempController.view.frame = CGRectMake(0, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                        
                    }else{
                        
                        self.tempController.view.frame = CGRectMake(-self.view.width, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                    }
                ...
                if (animated) {
                    ...
                    [UIView animateWithDuration:AnimateDuration animations:^{
                        ...
                        if (isSuccess) {
                            ...
                            weakSelf.currentController.view.frame = CGRectMake(-self.view.width, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                            
                        } else {
                            
                            weakSelf.currentController.view.frame = CGRectMake(0, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                        }
                    ...
                    if (isSuccess) {
                        ...
                        self.currentController.view.frame = CGRectMake(-self.view.width, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                        
                    } else {
                        
                        self.currentController.view.frame = CGRectMake(0, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                    }
                ...
                if (animated) {
                    ...
                    [UIView animateWithDuration:AnimateDuration animations:^{
                        ...
                        if (isSuccess) {
                            ...
                            weakSelf.tempView.frame = CGRectMake(0, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                            
                        } else {
                            
                            weakSelf.tempView.frame = CGRectMake(-self.view.width, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                        }
                    ...
                    if (isSuccess) {
                        ...
                        self.tempView.frame = CGRectMake(0, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                        
                    } else {
                        
                        self.tempView.frame = CGRectMake(-self.view.width, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                    }
                ...
                if (animated) {
                    ...
                    [UIView animateWithDuration:AnimateDuration animations:^{
                        ...
                        if (isSuccess) {
                            ...
                            weakSelf.currentView.frame = CGRectMake(-self.view.width, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                            
                        } else {
                            
                            weakSelf.currentView.frame = CGRectMake(0, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                        }
                    ...
                    if (isSuccess) {
                        ...
                        self.currentView.frame = CGRectMake(-self.view.width, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                        
                    } else {
                        
                        self.currentView.frame = CGRectMake(0, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
                    }
...
- (void)addController:(UIViewController * _Nullable)controller {
    if (controller) {
        ...
        if (self.isLeft) { // 左边
            ...
            controller.view.frame = CGRectMake(-self.view.width, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
            ...
            controller.view.frame = CGRectMake(0, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
        }
...
- (void)addView:(UIView * _Nullable)view {
    if (view) {
        ...
        if (self.isLeft) { // 左边
            ...
            view.frame = CGRectMake(-self.view.width, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
            ...
            view.frame = CGRectMake(0, self.viewFrame.origin.y, self.view.width, self.viewFrame.size.height);
        }
...
//    self.tempController.view.frame = self.view.bounds;
    self.tempController.view.frame = self.viewFrame;
...
//    self.tempView.frame = self.view.bounds;
    self.tempView.frame = self.viewFrame;
